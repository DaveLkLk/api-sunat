...
function soapCall($wsdlURL, $callFunction = "", $XMLString) {
    // Agregado kapaza -> configuracion previa para cargar el WS sin restriccion de entidad.
    $options = [
            'cache_wsdl' => WSDL_CACHE_BOTH, // Guarda la caché del WSDL
            'trace' => true,                 // Habilita el rastreo para depuración
            'exceptions' => true,            // Lanza excepciones en errores SOAP
            'stream_context' => stream_context_create([
                'ssl' => [
                    'verify_peer' => true,       // No verifica el certificado SSL
                    'verify_peer_name' => false, // No verifica el nombre del host
                ]
            ])
        ];
    // $client = new feedSoap($wsdlURL, array('trace' => true));
    $client = new feedSoap($wsdlURL, $options);
...
switch ($_GET['cod_2']) {
    case 0:
        ...
        // $wsdlURL = './eBetaWS.xsdl';
        break;
    case 1:
        $wsdlURL = 'billService.wsdl';
        break;
    case 2://Beta DigiFlow
        $wsdlURL = 'https://pruebas.ecomprobantes.pe/wssCustomerETDLoadASPUBL21/CustomerETDLoadASP.asmx';
        break;
}
